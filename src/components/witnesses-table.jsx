...
const COL_ID_MISSED = 5;
const COL_ID_LAST_CONFIRMED_BLOCK = 6;

class WitnessesTable extends PureComponent {
  constructor(props) {
    super(props);
    ...
    let data = sortBy(this.state.data, (item) => {
      switch (sortById) {
        ...
        case COL_ID_URL:
          return item.url;
        case COL_ID_MISSED:
          return +item.total_missed;
        case COL_ID_LAST_CONFIRMED_BLOCK:
          return +item.last_confirmed_block_num;
        default:
...
WitnessesTable.propTypes = {
  data: PropTypes.arrayOf(PropTypes.shape({
    ...
    total_missed: PropTypes.number,
    last_confirmed_block_num: PropTypes.number,
  })).isRequired,
};
